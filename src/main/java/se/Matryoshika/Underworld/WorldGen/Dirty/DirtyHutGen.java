...
public class DirtyHutGen implements IWorldGenerator {
	...
	final int[][] COBBLE_BLOCKS = new int[][] { { 2, 0, 4 }, { 2, 0, 3 }, { 2, 0, 2 }, { 2, 0, 1 }, { 2, 0, 0 }, { 2, 0, -1 }, { 2, 0, -2 }, { 2, 0, -3 }, { 2, 0, -4 }, { 1, 0, -4 }, { 0, 0, -4 }, { -1, 0, -4 }, { -2, 0, -4 }, { -3, 0, -4 }, { -3, 0, -3 }, { -3, 0, -2 }, { -3, 0, -1 }, { -3, 0, 0 }, { -3, 0, 1 }, { -3, 0, 2 }, { -3, 0, 3 }, { -3, 0, 4 }, { -2, 0, 4 }, { -1, 0, 4 }, { 0, 0, 4 }, { 1, 0, 4 }, { 1, 1, 4 }, { 1, 2, 4 }, { 1, 3, 4 }, { 2, 3, 3 }, { 2, 2, 3 }, { 2, 1, 3 }, { 2, 1, -3 }, { 2, 2, -3 }, { 2, 3, -3 }, { 1, 3, -4 }, { 1, 2, -4 }, { 1, 1, -4 }, { -2, 1, -4 }, { -2, 2, -4 }, { -2, 3, -4 }, { -3, 3, -3 }, { -3, 2, -3 }, { -3, 1, -3 }, { -3, 1, 3 }, { -3, 2, 3 }, { -3, 3, 3 }, { -2, 3, 4 }, { -2, 2, 4 }, { -2, 1, 4 } };
	final int[][] PLANK_BLOCKS = new int[][] { { -2, 0, 3 }, { -2, 0, 2 }, { -2, 0, 1 }, { -2, 0, 0 }, { -2, 0, -1 }, { -2, 0, -2 }, { -2, 0, -3 }, { -1, 0, 3 }, { -1, 0, 2 }, { -1, 0, 1 }, { -1, 0, 0 }, { -1, 0, -1 }, { -1, 0, -2 }, { -1, 0, -3 }, { 0, 0, 3 }, { 0, 0, 2 }, { 0, 0, 1 }, { 0, 0, 0 }, { 0, 0, -1 }, { 0, 0, -2 }, { 0, 0, -3 }, { 1, 0, 3 }, { 1, 0, 2 }, { 1, 0, 1 }, { 1, 0, 0 }, { 1, 0, -1 }, { 1, 0, -2 }, { 1, 0, -3 }, { 0, 1, 4 }, { -1, 1, 4 }, { 0, 3, 4 }, { -1, 3, 4 }, { -1, 1, -4 }, { 0, 1, -4 }, { -1, 3, -4 }, { 0, 3, -4 }, { 2, 1, -2 }, { 2, 1, -1 }, { 2, 1, 0 }, { 2, 1, 2 }, { 2, 2, 2 }, { 2, 2, 0 }, { 2, 3, -2 }, { 2, 3, -1 }, { 2, 3, 0 }, { 2, 3, 1 }, { 2, 3, 2 }, { -3, 1, 2 }, { -3, 1, 1 }, { -3, 1, 0 }, { -3, 1, -1 }, { -3, 1, -2 }, { -3, 2, -2 }, { -3, 2, 0 }, { -3, 3, 2 }, { -3, 3, 1 }, { -3, 3, 0 }, { -3, 3, -1 }, { -3, 3, -2 }, { -2, 4, 3 }, { -2, 4, 2 }, { -2, 4, 1 }, { -2, 4, 0 }, { -2, 4, -1 }, { -2, 4, -2 }, { -2, 4, -3 }, { -1, 4, 3 }, { -1, 4, 2 }, { -1, 4, 1 }, { -1, 4, 0 }, { -1, 4, -1 }, { -1, 4, -2 }, { -1, 4, -3 }, { 0, 4, 3 }, { 0, 4, 2 }, { 0, 4, 1 }, { 0, 4, 0 }, { 0, 4, -1 }, { 0, 4, -2 }, { 0, 4, -3 }, { 1, 4, 3 }, { 1, 4, 2 }, { 1, 4, 1 }, { 1, 4, 0 }, { 1, 4, -1 }, { 1, 4, -2 }, { 1, 4, -3 }, };
	final int[][] GLASS_BLOCKS = new int[][] { { 2, 2, -1 }, { 2, 2, -2 }, { 0, 2, -4 }, { -1, 2, -4 }, { -3, 2, -2 }, { -3, 2, -1 }, { -3, 2, 1 }, { -3, 2, 2 }, { -1, 2, 4 }, { 0, 2, 4 } };
	final int[][] COBBLE_PILLARS = new int[][] { { 2, 1, 4 }, { 2, 2, 4 }, { 2, 1, -4 }, { 2, 2, -4 }, { -3, 1, -4 }, { -3, 2, -4 }, { -3, 1, 4 }, { -3, 2, 4 } };
	final int[][] WOODEN_SLABS = new int[][] { { 2, 4, 4 }, { 1, 5, 3 }, { 2, 4, -4 }, { 1, 5, -3 }, { -3, 4, -4 }, { -3, 4, 4 }, { -2, 5, -3 }, { -2, 5, 3 }, { 0, 6, 2 }, { -1, 6, 2 }, { 0, 6, -2 }, { -1, 6, -2 } };
	final int[][] STAIRS = new int[][] { { 3, 3, 4, 1 }, { 3, 3, 3, 1 }, { 3, 3, 2, 1 }, { 3, 3, 1, 1 }, { 3, 3, 0, 1 }, { 3, 3, -1, 1 }, { 3, 3, -2, 1 }, { 3, 3, -3, 1 }, { 3, 3, -4, 1 }, { 2, 4, 3, 1 }, { 2, 4, 2, 1 }, { 2, 4, 1, 1 }, { 2, 4, 0, 1 }, { 2, 4, -1, 1 }, { 2, 4, -2, 1 }, { 2, 4, -3, 1 }, { 1, 5, -2, 1 }, { 1, 5, -1, 1 }, { 1, 5, 0, 1 }, { 1, 5, 1, 1 }, { 1, 5, 2, 1 }, { 0, 6, 1, 1 }, { 0, 6, 0, 1 }, { 0, 6, -1, 1 }, { -4, 3, -4, 0 }, { -4, 3, -3, 0 }, { -4, 3, -2, 0 }, { -4, 3, -1, 0 }, { -4, 3, 0, 0 }, { -4, 3, 1, 0 }, { -4, 3, 2, 0 }, { -4, 3, 3, 0 }, { -4, 3, 4, 0 }, { -3, 4, 3, 0 }, { -3, 4, 2, 0 }, { -3, 4, 1, 0 }, { -3, 4, 0, 0 }, { -3, 4, -1, 0 }, { -3, 4, -2, 0 }, { -3, 4, -3, 0 }, { -2, 5, -2, 0 }, { -2, 5, -1, 0 }, { -2, 5, 0, 0 }, { -2, 5, 1, 0 }, { -2, 5, 2, 0 }, { -1, 6, 1, 0 }, { -1, 6, 0, 0 }, { -1, 6, -1, 0 }, { -3, 3, -5, 2 }, { -2, 3, -5, 2 }, { -1, 3, -5, 2 }, { 0, 3, -5, 2 }, { 1, 3, -5, 2 }, { 2, 3, -5, 2 }, { 1, 4, -4, 2 }, { 0, 4, -4, 2 }, { -1, 4, -4, 2 }, { -2, 4, -4, 2 }, { -1, 5, -3, 2 }, { 0, 5, -3, 2 }, { -3, 3, 5, 3 }, { -2, 3, 5, 3 }, { -1, 3, 5, 3 }, { 0, 3, 5, 3 }, { 1, 3, 5, 3 }, { 2, 3, 5, 3 }, { 1, 4, 4, 3 }, { 0, 4, 4, 3 }, { -1, 4, 4, 3 }, { -2, 4, 4, 3 }, { -1, 5, 3, 3 }, { 0, 5, 3, 3 }
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
		...
		for (int y = 32; y < 80; y++) {
			...
			if (canGenerate(world, blockX, blockY, blockZ)) {
				// System.out.println("Placed a house at: " + Print.print(blockX, blockY-1,
				// blockZ));
	...
	private void generateStructure(World world, int x, int y, int z, Random rand) {
		...
		if (genRand.nextInt(40) == 0) {
			...
			IBlockState iblockstate1 = Blocks.BED.getDefaultState().withProperty(BlockBed.FACING, EnumFacing.byName("north")).withProperty(BlockBed.PART, BlockBed.EnumPartType.FOOT);
			IBlockState iblockstate2 = Blocks.BED.getDefaultState().withProperty(BlockBed.FACING, EnumFacing.byName("north")).withProperty(BlockBed.PART, BlockBed.EnumPartType.HEAD);
