...
public abstract class CustomStructureComponent
{
    ...
    public CustomStructureComponent()
    {
    }

    protected CustomStructureComponent(int type)
    {
    ...
    {
        if (CustomMapGenStructureIO.getStructureComponentName(this) == null) // Friendlier error then the Null String error below.
        {
        ...
        nbttagcompound.setString("id", CustomMapGenStructureIO.getStructureComponentName(this));
        if(boundingBox != null){}
        else{
     ...
     */
    public void buildComponent(CustomStructureComponent componentIn, List<CustomStructureComponent> listIn, Random rand)
    {
    }
     ...
     */
    public static CustomStructureComponent findIntersecting(List<CustomStructureComponent> listIn, StructureBoundingBox boundingboxIn)
    {
        for (CustomStructureComponent structurecomponent : listIn)
        {
     ...
     */
    protected void fillWithRandomizedBlocks(World worldIn, StructureBoundingBox boundingboxIn, int minX, int minY, int minZ, int maxX, int maxY, int maxZ, boolean alwaysReplace, Random rand, CustomStructureComponent.BlockSelector blockselector)
    {
        for (int i = minY; i <= maxY; ++i)
        {
            for (int j = minX; j <= maxX; ++j)
