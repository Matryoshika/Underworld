...
public class ChunkGeneratorSettingsCaves {
	...
	private ChunkGeneratorSettingsCaves(ChunkGeneratorSettingsCaves.Factory settingsFactory)
    {
	...
	public static class Factory {
		@VisibleForTesting
		static final Gson JSON_ADAPTER = (new GsonBuilder()).registerTypeAdapter(ChunkGeneratorSettingsCaves.Factory.class, new ChunkGeneratorSettingsCaves.Serializer()).create();
		...
		public static ChunkGeneratorSettingsCaves.Factory jsonToFactory(String p_177865_0_) {
			if (p_177865_0_.isEmpty()) {
				return new ChunkGeneratorSettingsCaves.Factory();
			} else {
				try {
					return (ChunkGeneratorSettingsCaves.Factory) JsonUtils.gsonDeserialize(JSON_ADAPTER, p_177865_0_, ChunkGeneratorSettingsCaves.Factory.class);
		...
		public boolean equals(Object p_equals_1_) {
			if (this == p_equals_1_) {
				...
				ChunkGeneratorSettingsCaves.Factory chunkgeneratorsettings$factory = (ChunkGeneratorSettingsCaves.Factory) p_equals_1_;
		...
		public ChunkGeneratorSettingsCaves build() {
			return new ChunkGeneratorSettingsCaves(this);
		}
	}

	public static class Serializer implements JsonDeserializer<ChunkGeneratorSettingsCaves.Factory>, JsonSerializer<ChunkGeneratorSettingsCaves.Factory> {
		public ChunkGeneratorSettingsCaves.Factory deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
			JsonObject jsonobject = p_deserialize_1_.getAsJsonObject();
			ChunkGeneratorSettingsCaves.Factory chunkgeneratorsettings$factory = new ChunkGeneratorSettingsCaves.Factory();
		...
		public JsonElement serialize(ChunkGeneratorSettingsCaves.Factory p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_) {
