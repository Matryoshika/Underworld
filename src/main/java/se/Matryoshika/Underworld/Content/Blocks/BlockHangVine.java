...
public class BlockHangVine extends Block implements net.minecraftforge.common.IShearable {
	...
	public BlockHangVine() {
		super(Material.VINE);
		this.setDefaultState(this.blockState.getBaseState().withProperty(UP, Boolean.valueOf(false)).withProperty(NORTH, Boolean.valueOf(false)).withProperty(EAST, Boolean.valueOf(false)).withProperty(SOUTH, Boolean.valueOf(false)).withProperty(WEST, Boolean.valueOf(false)));
		this.setTickRandomly(true);
		this.setCreativeTab(Underworld.UnderworldTab);
		this.setUnlocalizedName("hangVine");
		this.setRegistryName(Underworld.MODID, "hangVine");
	}
				...
				if (pos.getY() > 1) {
					...
					if (block.getMaterial(iblockstate) == Material.AIR) {
						if (rand.nextInt(16) == 0)
							worldIn.setBlockState(blockpos3, worldIn.getBlockState(pos), 2);
					}
				}
			}
		}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
		state = state.withProperty(getPropertyFor(placer.getHorizontalFacing()), Boolean.valueOf(true));
	}
